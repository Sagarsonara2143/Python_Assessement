...
search=Button(root,text="SEARCH",font=("Sans-serif 15"),fg="black",bg="orange", width=20, bd=6).place(x=300,y=400)

update=Button(root,text="UPDATE",font=("Sans-serif 15"),fg="black",bg="orange", width=20, bd=6).place(x=50,y=450)

delete=Button(root,text="DELETE",font=("Sans-serif 15"),fg="black",bg="orange", width=20, bd=6).place(x=300,y=450)
