...
# Label and place
l_email=Label(root,text="Email", font=("Sans-serif 15"), bg="white")
...
l_reg = Label(root, text="Sign up",font=("Sans-serif 14 underline"),fg="blue").place(x=350, y=220)
...
#Button
login=Button(root,text="LOGIN",font=("Sans-serif 15"),fg="black",bg="orange", width=10, command = register_page)
